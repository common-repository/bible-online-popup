...
For reasons that are not in charge of developer of this plugin, currently there are not all of the translations available on BibleOnline.ru for browser reading, that you can use in plugin. Also, unfortunately, there's no English version provided for AJAX yet.
...
Also, not for every translation the book name will be translated. Mostly it appears in Russian.
